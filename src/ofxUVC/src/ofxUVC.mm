...
void ofxUVC::camera0(){
    ...
    cameraControl = [[UVCCameraControl alloc] initWithLocationID:437452800];
    cameraInited = true;
    
}
void ofxUVC::camera1(){

    cameraControl = [[UVCCameraControl alloc] initWithLocationID:487784448];
    cameraInited = true;
}

void ofxUVC::setCamera(int uniqueId){
